...
from DMRST.DMRST_module import EncoderRNN, DecoderRNN, PointerAtten, LabelClassifier, Segmenter
from DMRST.DMRST_DataHandler import get_RelationAndNucleus
from random import randint
import DMRST.DMRST_config as DMRST_config
...
class ParsingNet(nn.Module):
    def __init__(self, language_model, word_dim=768, hidden_size=768, decoder_input_size=768,
        ...
        self.encoder = EncoderRNN(language_model, word_dim, hidden_size, DMRST_config.enc_rnn_layer_num, dropout_e, bert_tokenizer=bert_tokenizer, segmenter=self.segmenter)
                ...
                for j in range(len(cur_DecoderInputIndex)):
                    ...
                    if stacks[-1] != '__StackRoot__':
                        ...
                        if len(stack_head) < 3:
                            ...
                            if DMRST_config.average_edu_level is True:
