...
def truncate_paper_text(paper_text, prompt_template, max_model_len=65000):
    """
...
def LLM_Generated_Review(user_message, timeout=None):
    ...
    调用 API 并返回生成结果。
    """
    api_url = "http://172.27.33.102:8714/v1/chat/completions"
...
if __name__ == "__main__":
    ...
    LLM_review_file = "/mnt/data132/taozhen/LLM_Review_Detection/Dataset/LLM_Review/Internlm/ICLR1.json"
