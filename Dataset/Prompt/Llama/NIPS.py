...
def truncate_paper_text(paper_text, prompt_template, max_model_len=130000):
    """
...
def LLM_Generated_Review(user_message, timeout=None):
    ...
    调用 API 并返回生成结果。
    """
    api_url = "http://172.27.33.102:8712/v1/chat/completions"
    model_path = "/mnt/data102_d2/huggingface/models/Meta-Llama-3.1-8B-Instruct/"
    temperature = 0.9
...
if __name__ == "__main__":
    ...
    LLM_review_file = "/mnt/data132/taozhen/LLM_Review_Detection/Dataset/LLM_Review/Llama/NIPS1.json"
