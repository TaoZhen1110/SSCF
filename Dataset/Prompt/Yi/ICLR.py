...
def truncate_paper_text(paper_text, prompt_template, max_model_len=15000):
    """
...
def LLM_Generated_Review(user_message, timeout=None):
    ...
    调用 API 并返回生成结果。
    """
    api_url = "http://172.27.33.102:8715/v1/chat/completions"
    model_path = "/mnt/data102_d2/huggingface/models/Yi-1.5-34B-Chat-16K/"
    temperature = 0.9
...
if __name__ == "__main__":
    ...
    LLM_review_file = "/mnt/data132/taozhen/LLM_Review_Detection/Dataset/LLM_Review/Yi/ICLR1.json"
