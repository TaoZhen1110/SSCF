...
if __name__ == "__main__":
    ...
    Paper_file = "/mnt/data132/taozhen/LLM_Review_Detection/Dataset/Human_Review/NIPS/Papers.json"
    LLM_review_file = "/mnt/data132/taozhen/LLM_Review_Detection/Dataset/LLM_Review/Mistral/NIPS1.json"
